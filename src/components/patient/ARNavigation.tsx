...
const ARNavigation: React.FC<ARNavigationProps> = ({ onBack }) => {
  ...
  const HEADING_SMOOTHING_WINDOW = 10; // Average over the last 10 readings for more stability
  ...
  useEffect(() => {
    ...
    const handleMotion = (event: DeviceMotionEvent) => {
        ...
        // Fine-tuned thresholds for more deliberate step detection
        const STEP_UP_THRESHOLD = 12.0; 
        const STEP_DOWN_THRESHOLD = 9.5;
